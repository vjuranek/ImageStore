...
CREATE TABLE image(id SERIAL PRIMARY KEY, client_id integer REFERENCES client, path varchar(4096), name varchar(256), sha256 varchar(256), created timestamp, upload_finished boolean);
